...
image::file2.png[]
Настроим объем памяти, занимаемый _Stack_ и _Heap_. Для этого в меню _Options-Linker_ поставим галочку в пункт _Override default_, нажмём _Edit..._ и отведем по 0x1000 бит для _Stack_ и _Heap_ (рисунок 3).
